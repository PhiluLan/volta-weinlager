...
type Wine = { name: string; producer: string; vintage: string; category: string; stock: number; minStock: number };
  ...
  return (
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-bottom"><div className="nav-label">Verwaltung</div><button className="nav-item"><span className="nav-icon">⚙</span>Einstellungen</button><div className="user-chip"><div className="avatar">PS</div><div><strong>Philipp</strong><span>Administrator</span></div><span className="dots">•••</span></div></div>
      </aside>
